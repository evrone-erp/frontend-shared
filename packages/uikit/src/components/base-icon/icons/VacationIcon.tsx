...
export function VacationIcon(props: ConcreteIconProps) {
  return (
    <IconRoot {...props} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <line x1="1" y1="21.2" x2="22" y2="21.2" stroke="none" strokeOpacity="0.64" strokeWidth="1.6" />
      <path d="M9.0898 14.6419L3.92941 14.4336L2.70279 15.4471L8.70349 17.7132L21.3786 7.23992C21.8302 6.86674 21.8938 6.1981 21.5206 5.74647C21.1474 5.29485 20.4788 5.23125 20.0272 5.60443L16.5517 8.47615L4.39538 8.54427L3.3732 9.38889L12.2586 12.0236L9.0898 14.6419Z" />
      <path
