...
export type LocalTextFieldProps = PasswordFieldProps | PhoneFieldProps | SelectFieldProps | CommonFieldProps;
...
type CustomMuiProps = OverridedMuiProps & Omit<MuiProps, keyof OverridedMuiProps> & BaseComponentProps;
